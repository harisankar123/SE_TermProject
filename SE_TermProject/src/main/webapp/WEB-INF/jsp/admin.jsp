...
<div class="tab">
  <button class="tablinks" onclick="openCity(event, 'AllUser')">AllUser</button>
  <button class="tablinks" onclick="openCity(event, 'AllPost')">AllPost</button>
  
</div>
<div id="AllUser" class="tabcontent">
	<table class="table table-bordered">
				...
				<c:forEach items="${user}" var="u">
      			  <tr>
      			       <td><img src="${u.profilephoto}" height="50" width="50" alt="Profile Image" /></td>
      			      <td> <a href ="/redirectProfile?userId=${u.userId}">
            		   ${u.name}
            		   </a></td>
                  </tr>
    			</c:forEach>
...
<table class="table table-bordered">
		<thead>
				...
				<tbody id="tableBody">
				<c:forEach items="${user}" var="pst">
      			  <tr>
      			       <td><img src="${pst.postPhoto}" height="50" width="50" alt="Profile Image" /></td>
      			      <td> <audio autoplay>
								<source src="${pst.postAudio}" type="audio/webm">
							</audio>
            		   </td>
                  </tr>
    			</c:forEach>
